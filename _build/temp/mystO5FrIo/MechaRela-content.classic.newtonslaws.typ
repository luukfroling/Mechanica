...
#figure(
  image("files/ch2_Example1-fc6eb5a0d45e097c6d76b7c761f4aef7.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
) <fig:example1>
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-lbebhixajv", heading: [A pushing contest 🌶])[
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_ex_carts-d0d5a72e77882f4e393bfc02268dbfb5.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
) <fig:pushing-contest>]
...
From Newton's 2$""^(n d)$ and 3$""^r d$ law we can easily derive the law of conservation of momentum. Assume there are only two point-particle (i.e. particles with no size but with mass), that exert a force on each other. No other forces are present. From N2 we have: <index-nzqkptz5fu>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Inclined_plane-ed39a45b325f2edb839640fd60fdda40.svg", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Inclined_plane_s-02378b1758b496ec09dbbc8f07670e55.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_vectors-5d813d1e30102322baa29c254ef4e33d.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_figure_ex_toss-de31478b4135b56222ac4c1c897dfcd6.svg", width: 30%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_fig_hor_mot-1df357723bbb693ee5c12eecb718f0dd.svg", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/parmotionv-3e85c258df1d8769eedd33a4e3a1821a.svg", width: 70%),
  caption: [
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-zoupsxd7q1", heading: [Horizontal throw 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/Parabolic-8eadb1cae74b793d969643af19c58ce5.png", width: 70%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_ex_pj-f3ba17cc089b8e74619baea7a57a76ff.svg", width: 90%),
  kind: "figure",
  supplement: [Figure],
)
]
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-pduhfupvng", heading: [A rocket in space 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/bookwall-bea47c80fdff46d5c34bce0497b68315.png", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/FBD_ex_book-3a96fef689993a16f2f7eb777a317b9f.png", width: 60%),
  kind: "figure",
  supplement: [Figure],
) <fig_fbd_book>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Example2-d876120532ec46a87725d33436029ed1.svg", width: 20%),
  caption: [
align: center
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_UsingABalance-9a69648438eb26c55e833d4c10da03a5.svg", width: 40%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_EotvosExperiment-b41529e3a7b73a3a3abf78fb03536e03.svg", width: 50%),
  caption: [
