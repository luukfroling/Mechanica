...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/CM_r1r2-2e1bbd18e6ac5d223a46103a3c440284.png", width: 43.75%),
  caption: [
...
The total angular momentum is, like the total momentum, defined as the sum of the angular momentum of the two particles: <index-emdqvlw3o5>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/KeplerRevisited-6fbffe66eaf339fa7333cd062c0b1cad.png", width: 43.75%),
  caption: [
Kepler revisited.
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/EarthSunCoG-6c02c3ec2de6ce94d5b08de2b9c31729.png", width: 31.25%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/radial_velocity-b47b720f63bad5883f08c2f6afcd9cc0.png", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/transit_method_singl-e595afb536d0ef756855bc7466d75152.png", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ManyParticles-4c52c0ecf5bc8070eba31e84c0d5f88e.png", width: 18.75%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/HenriPoincare-bf02c3cf40cd19b5e03568f9bbde21f9.jpg", width: 40%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/20SolutionsThreeBody-d87cb96573bc7c6bad027a1e4e3ce8ba.png", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/TwoBody_animation-987eaea08228102bbc3588aa1cd3d387.png", width: 100%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ThreeBody_animation_-afe094190946b545c4fbefea94492db0.png", width: 100%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ThreeBody_animation_-c291fa7e50dfa0e3ad5af1233ae7519b.png", width: 100%),
  caption: [
