...
#figure(
  image("files/WorkedEx2.1-ec86cf9ec23daf3c9135a6bea4dd963d.svg", width: 60%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/WorkedEx3.2-b68a101e2f3e060483fe6064d7f4e57b.svg", width: 60%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch3_ex_force_field-58c3d71887457d15f9a655b3590ea705.svg", width: 50%),
  caption: [
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-av1xq2z7qg", heading: [🌶])[
...
Click for the solution #link("/ExerciseFrictionNotC-672759d9a4a39a8b00bad4d1629cda14.pdf")[Friction Not Conservative].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<52>)[Exercise~4]])[
Click for the solution #link("/ExerciseConservative-9e3449f926e493e49804b390e7f6048a.pdf")[Conservative Force].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<53>)[Exercise~5]])[
Click for the solution #link("/ExerciseConservative-bc7ebce63a7bfa8e4b7525381a03fef2.pdf")[Non-Conservative Force].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<54>)[Exercise~6]])[
Click for the solution #link("/PotentialEnergyxy-29a7c9c248dd8f7112ce46beae04cdd6.pdf")[Potential energy \& Force].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<55>)[Exercise~7]])[
Click for the solution #link("/ForceField-074d50636fa19b1eae3fe750f1883d44.pdf")[Force Field].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<56>)[Exercise~8]])[
Click for the solution #link("/ForceSin-73563be33d5bb6231d54659ca372b026.pdf")[Sinusoidal Force Field].]
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch4_ballspring-b7df76dccc1d5f4400203802335dcf95.svg", width: 35%),
  kind: "figure",
  supplement: [Figure],
)
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-vk26ttygql", heading: [Pushing a box uphill #footnote[Exercise from Idema, T. (2023). Introduction to particle and continuum mechanics. #cite(<2023>, form: "prose")] 🌶])[
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-bekltxlo9k", heading: [Work done dragging a board #footnote[Exercise from Idema, T. (2023). Introduction to particle and continuum mechanics. #cite(<2023>, form: "prose")] 🌶 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch4_draggingboard-7bcc35319ebedbfeee000b633b9de24d.svg", width: 90%),
  kind: "figure",
  supplement: [Figure],
)
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-sckjx65dk6", heading: [Work by a lineair force 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/WorkExample4_3-a14a2c4516ff0573d3181b362244e49a.png", width: 70%),
  kind: "figure",
  supplement: [Figure],
)]
