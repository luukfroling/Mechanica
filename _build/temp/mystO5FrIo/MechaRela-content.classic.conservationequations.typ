...
Updated: 05 feb 2026
In the previous chapters, we have seen that from Newton's three laws, we can obtain conservation laws. That means, under certain conditions (depending on the law), a specific quantity cannot change. <index-yx1nbhjwft>
...
#figure(
  image("files/ch7_GTsystem-ee2b821f7c2bb0952064ed1d92a8c392.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch7_GalileiTransform-e8f184ffb0d228df69dc35aa50750dbc.svg", width: 40%),
  caption: [
