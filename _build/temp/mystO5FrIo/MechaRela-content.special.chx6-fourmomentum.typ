...
#figure(
  image("files/einsteintriangle-852ec559e03071bd5f6f1c669aa4f8ca.svg", width: 70%),
  caption: [
Einstein triangle.
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/chx6_gamma_v-36feb104fbeefe8b8fc3b28743f31664.svg", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/CherenkovRadiation-5a414ebda09107e1b73f31a1921851b7.jpg", width: 43.75%),
  caption: [
