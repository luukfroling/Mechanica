...
#figure(
  image("files/FourParticles-80425051e971a4e99a846b07096318fa.png", width: 70%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/Wheel8Masses-f259bb2a7eba8d3130555d5643dcdd82.png", width: 70%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/FourParticlesVectors-6bed36ca5e6bcbd60673ffd352fe9545.png", width: 90%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/Dustparticles_animat-ef6c31fc6dfb5c4ce001a9b87032cf4c.png", width: 90%),
  caption: [
