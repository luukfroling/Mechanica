...
#figure(
  image("files/einsteintriangle-0a5fc19d2f68fefe5552ca6d17e85a71.svg", width: 70%),
  caption: [
Einstein triangle.
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/chx6_gamma_v-09fceb35e1f4b978b9eeb4baf295b161.svg", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/CherenkovRadiation-191b0dd3eac86c5abdd937f433402b5d.jpg", width: 43.75%),
  caption: [
