...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/CM_r1r2-a37d81a6320fc6b21fba0f02375d997d.png", width: 43.75%),
  caption: [
...
The total angular momentum is, like the total momentum, defined as the sum of the angular momentum of the two particles: <index-xi4xzi4tns>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/KeplerRevisited-2c72c173204cb91569d15d2a0cd231f6.png", width: 43.75%),
  caption: [
Kepler revisited.
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/EarthSunCoG-2689056a03a33b1613aaa24d2e7b56ba.png", width: 31.25%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/radial_velocity-8f97d6509251201e7d311a1d1fb92ae4.png", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/transit_method_singl-9e1a7db54180725fda8137d00cc76409.png", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ManyParticles-a6f6d8f78dbbd89a1da0eda4633ca539.png", width: 18.75%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/HenriPoincare-eec6f8a4eb0fb4aec4fbbff7d12d58bf.jpg", width: 40%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/20SolutionsThreeBody-6c78b9835e0981188a3f2a951e811829.png", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/TwoBody_animation-7d0b00f7217a86035e41e3f98c024050.png", width: 100%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ThreeBody_animation_-0f154b5316cfe4267a2f45dc643b8a52.png", width: 100%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ThreeBody_animation_-82b49cf86b090996d0ca35643c9e2cd3.png", width: 100%),
  caption: [
