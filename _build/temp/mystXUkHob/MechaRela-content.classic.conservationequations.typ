...
Updated: 05 feb 2026
In the previous chapters, we have seen that from Newton's three laws, we can obtain conservation laws. That means, under certain conditions (depending on the law), a specific quantity cannot change. <index-knszo5kvqc>
...
#figure(
  image("files/ch7_GTsystem-573ef5417469ddb1e94130f76c6cf1b6.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch7_GalileiTransform-bca9da79f19cd657ec29beadb0a2c480.svg", width: 40%),
  caption: [
