...
#figure(
  image("files/WorkedEx2.1-15e27db5edd738eca2105fcae52915de.svg", width: 60%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/WorkedEx3.2-07a26a24b07321c87c801febac02ad1e.svg", width: 60%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch3_ex_force_field-f6069e6b25d0a6ad559a10b76257f7ab.svg", width: 50%),
  caption: [
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-cwqengbbig", heading: [🌶])[
...
Click for the solution #link("/ExerciseFrictionNotC-31b09f0a47f890842c6f1e749f1d2122.pdf")[Friction Not Conservative].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<52>)[Exercise~4]])[
Click for the solution #link("/ExerciseConservative-b3eb8854ff0e388b0497e4318a7edee0.pdf")[Conservative Force].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<53>)[Exercise~5]])[
Click for the solution #link("/ExerciseConservative-135b1218a3751a8fbd05e27570b8e88c.pdf")[Non-Conservative Force].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<54>)[Exercise~6]])[
Click for the solution #link("/PotentialEnergyxy-5239aa649b0a51005096cd6707235a16.pdf")[Potential energy \& Force].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<55>)[Exercise~7]])[
Click for the solution #link("/ForceField-2d42e597c10f5c70fe5652f804fc7e73.pdf")[Force Field].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<56>)[Exercise~8]])[
Click for the solution #link("/ForceSin-00e23a3069307220e2ce258aa9b312be.pdf")[Sinusoidal Force Field].]
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch4_ballspring-f61316ab3d6daebe92ea3a36c0ca6ee3.svg", width: 35%),
  kind: "figure",
  supplement: [Figure],
)
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-aeeh2a13cx", heading: [Pushing a box uphill #footnote[Exercise from Idema, T. (2023). Introduction to particle and continuum mechanics. #cite(<2023>, form: "prose")] 🌶])[
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-fyu76ryem5", heading: [Work done dragging a board #footnote[Exercise from Idema, T. (2023). Introduction to particle and continuum mechanics. #cite(<2023>, form: "prose")] 🌶 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch4_draggingboard-33c883e14bac5840b354f5a0aac93e37.svg", width: 90%),
  kind: "figure",
  supplement: [Figure],
)
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-iavdzpkejh", heading: [Work by a lineair force 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/WorkExample4_3-1eb7149bca9ac883c2cbe631762a9630.png", width: 70%),
  kind: "figure",
  supplement: [Figure],
)]
