...
#figure(
  image("files/WorkedEx2.1-ac66d8d2c581f22c05a3a93244ca07e1.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_figure_ex_hill_s-189bf3c1c95c07c97d9861a0affdc303.svg", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Exercise2.1-c9ad66a76b3b20a715e79f316be0870c.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_FlyingBall-719369c13572dbfbfe7322c882f79a07.svg", width: 30%),
  kind: "figure",
  supplement: [Figure],
)
]
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Exercise2.4-6c5cabdfa8bdbcab5b7ac9b657ca834b.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Ex2.5-f19427a69c8004e214ad4046e82d06ce.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
) <fig:ex2.5>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Ex2.6-61daa7ed8322fd89783ca5cc20b8d4c9.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
) <fig:ex2.6>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Ex2.7-3f6a4f0efbc15c2c2481e183a67ee720.svg", width: 70%),
  kind: "figure",
  supplement: [Figure],
) <fig:ex2.7>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_MaxArea-34ba00f6b200066f0f233bae4c073348.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
) <fig:maxarea>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_FisMinar-5c6537463a9833cb57b73fc23f1242ed.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
) <fig:fisminar>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/DroppingAStone-cbffeac89615fe079aeac89bdaa790fe.png", width: 70%),
  caption: [
...
Write a computer program (e.g. in python) that calculates the motion of your object. See #link("/NumericalFallingPart-367dc2d8535f6e396729e4df7eef6eee.pdf")[Solution with Python] how you could do that.]
#proof(kind: "exercise", supplement: "Exercise", labelName: "2.17", heading: [Forces on your bike 🌶])[
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_BicycleRide-6d0809031fb2bfa080b58e9aee7ac5ba.svg", width: 40%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_bike-5735d341d5ac14393c70170c31c57bed.svg", width: 70%),
  kind: "figure",
  supplement: [Figure],
)]
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_SteppingOfABoat-9b3783624633487b45bce549f62b056b.svg", width: 70%),
  kind: "figure",
  supplement: [Figure],
) <fig:steppingofaboat>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/StampNewton-7ff22ba5d2d7805fa508fe67a81e8e80.jpg", width: 40%),
  caption: [
align: center
