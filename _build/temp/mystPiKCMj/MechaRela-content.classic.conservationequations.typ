...
Updated: 05 feb 2026
In the previous chapters, we have seen that from Newton's three laws, we can obtain conservation laws. That means, under certain conditions (depending on the law), a specific quantity cannot change. <index-fqzuv1mq2u>
...
#figure(
  image("files/ch7_GTsystem-e95460ee883ecc06109bee75a976f759.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch7_GalileiTransform-32357d0dbb265d47a99ab2cf23d8b5b8.svg", width: 40%),
  caption: [
