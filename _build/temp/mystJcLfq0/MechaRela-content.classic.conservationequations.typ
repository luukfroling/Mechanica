...
Updated: 05 feb 2026
In the previous chapters, we have seen that from Newton's three laws, we can obtain conservation laws. That means, under certain conditions (depending on the law), a specific quantity cannot change. <index-ikne0ourch>
...
#figure(
  image("files/ch7_GTsystem-317dac5fe9957b8b8557b305e5876caf.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch7_GalileiTransform-de0e84f8cafe52838ff2edeb937d2c8a.svg", width: 40%),
  caption: [
