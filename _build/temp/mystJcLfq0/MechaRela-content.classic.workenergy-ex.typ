...
#figure(
  image("files/WorkedEx2.1-828f4fcea28f477f636d1a044484014f.svg", width: 60%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/WorkedEx3.2-980baccb4f163a5593d3d3278c923de1.svg", width: 60%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch3_ex_force_field-6ef9e63419758d4ff09c6b3807688bb8.svg", width: 50%),
  caption: [
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-xl7kjoi3xc", heading: [🌶])[
...
Click for the solution #link("/ExerciseFrictionNotC-6c40ca22a24e789af6cc97c046dae6c7.pdf")[Friction Not Conservative].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<52>)[Exercise~4]])[
Click for the solution #link("/ExerciseConservative-d30e9f8acd6411037100a362fa9f724c.pdf")[Conservative Force].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<53>)[Exercise~5]])[
Click for the solution #link("/ExerciseConservative-9b28b1e82b8f692f1d162038afc34398.pdf")[Non-Conservative Force].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<54>)[Exercise~6]])[
Click for the solution #link("/PotentialEnergyxy-2ba2328e7fa4ff5cae07a27fd700a739.pdf")[Potential energy \& Force].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<55>)[Exercise~7]])[
Click for the solution #link("/ForceField-99e4a4dbc4c98983b23b49ceefc1d087.pdf")[Force Field].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<56>)[Exercise~8]])[
Click for the solution #link("/ForceSin-57871fd04a0224bb572b6f1050af75e7.pdf")[Sinusoidal Force Field].]
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch4_ballspring-dafdfb4c471f8ad429b284ea8b3805c0.svg", width: 35%),
  kind: "figure",
  supplement: [Figure],
)
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-xqypth7fk3", heading: [Pushing a box uphill #footnote[Exercise from Idema, T. (2023). Introduction to particle and continuum mechanics. #cite(<2023>, form: "prose")] 🌶])[
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-lropqxcpd3", heading: [Work done dragging a board #footnote[Exercise from Idema, T. (2023). Introduction to particle and continuum mechanics. #cite(<2023>, form: "prose")] 🌶 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch4_draggingboard-87746600763b42040fb36cf6475c0874.svg", width: 90%),
  kind: "figure",
  supplement: [Figure],
)
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-njj2uotec1", heading: [Work by a lineair force 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/WorkExample4_3-d0178796a9a2e93181dc77a28ba6cd7f.png", width: 70%),
  kind: "figure",
  supplement: [Figure],
)]
