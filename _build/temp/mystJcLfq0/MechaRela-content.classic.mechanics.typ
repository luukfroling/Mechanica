...
Updated: 05 feb 2026
In this part we cover the fundamentals of Classical Mechanics. We discuss the three laws of Newton and their first consequences. This part focusses on the primary concepts and quantities: _Force, Work, Energy, Angular Momentum_. We derive and discuss the conservation equations of these and their applications. Two topics receive special attention: _Oscillations_ and _Collisions_. We restrict the discussion to one-dimensional cases as much as possible to help understand the physics and not get lost in multi-dimensional problems at an early stage. However, more-dimensionality is not avoided as, for instance, it should be clear from the start that physics not only deals with numbers (better: scalars) but equally important, if not more important, with vectors. Moreover, _angular momentum_ and _torque_ by their very nature require multi-dimensional thinking.
