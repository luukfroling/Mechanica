...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/CM_r1r2-dd0a60c3e050d0c8e2773716b9f60a37.png", width: 43.75%),
  caption: [
...
The total angular momentum is, like the total momentum, defined as the sum of the angular momentum of the two particles: <index-jznkqqzvha>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/KeplerRevisited-f3b67e59f6474c95083f52f41109a69f.png", width: 43.75%),
  caption: [
Kepler revisited.
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/EarthSunCoG-9668b682854a1435fdacaaf94af2bb34.png", width: 31.25%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/radial_velocity-9365e4d057d35f4847412f0e54b5290e.png", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/transit_method_singl-d56c84068f89e8a00aae1f119312d38e.png", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ManyParticles-d90e5e623a128a2447d651a397d1eed1.png", width: 18.75%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/HenriPoincare-5505d94ba3cca9113477e632612bd721.jpg", width: 40%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/20SolutionsThreeBody-0eaa78997f18b87b192b74fe50b93b23.png", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/TwoBody_animation-0dc7b43332cd78a22da9896b4d906b7b.png", width: 100%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ThreeBody_animation_-b3a3e8d6c97d14db9df399c91294d11c.png", width: 100%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ThreeBody_animation_-ba3967476bb6eca00db7e653818dcfc1.png", width: 100%),
  caption: [
