...
Updated: 05 feb 2026
In the previous chapters, we have seen that from Newton's three laws, we can obtain conservation laws. That means, under certain conditions (depending on the law), a specific quantity cannot change. <index-xcqe7gmxdo>
...
#figure(
  image("files/ch7_GTsystem-50b622631961823cc7963faef125503f.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch7_GalileiTransform-41a46a931c9f93e0a405fee3b320f979.svg", width: 40%),
  caption: [
