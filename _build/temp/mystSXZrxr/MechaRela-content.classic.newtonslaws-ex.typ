...
#figure(
  image("files/WorkedEx2.1-9b08175c38fcfd2dd11f4eed245f89d4.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_figure_ex_hill_s-373fe265c85562c694134891ade287f5.svg", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Exercise2.1-3184d153512630db565e0d8b6f51f383.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_FlyingBall-e5375466058b8df4a02ba8007df7f154.svg", width: 30%),
  kind: "figure",
  supplement: [Figure],
)
]
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Exercise2.4-fa9890ad15e5c2cf4558bef39007c1ae.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Ex2.5-d2ed0c4d4fe1171612a0a16590e0e329.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
) <fig:ex2.5>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Ex2.6-186d98dbaf482c5679ae2ebbd23d26f1.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
) <fig:ex2.6>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Ex2.7-badd0f3d1d728abf5bff8a4df3f35f37.svg", width: 70%),
  kind: "figure",
  supplement: [Figure],
) <fig:ex2.7>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_MaxArea-b68e3466cad0a7d68d4018843b9bff89.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
) <fig:maxarea>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_FisMinar-fe12ffe611fe681c5d13401c36a89115.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
) <fig:fisminar>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/DroppingAStone-32e40c2ea8f426a74fea3cdc081d0299.png", width: 70%),
  caption: [
...
Write a computer program (e.g. in python) that calculates the motion of your object. See #link("/NumericalFallingPart-216c5528c59dd24531a900402921f1d6.pdf")[Solution with Python] how you could do that.]
#proof(kind: "exercise", supplement: "Exercise", labelName: "2.17", heading: [Forces on your bike 🌶])[
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_BicycleRide-7d49951954d4d9d6034874826dcf6b30.svg", width: 40%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_bike-54e6b42034d7c2ca8e66f005b7d6f11e.svg", width: 70%),
  kind: "figure",
  supplement: [Figure],
)]
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_SteppingOfABoat-89f98844903ff2974cc2189702d3de4c.svg", width: 70%),
  kind: "figure",
  supplement: [Figure],
) <fig:steppingofaboat>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/StampNewton-a264124dba764f7ba916f2fdcfb19d23.jpg", width: 40%),
  caption: [
align: center
