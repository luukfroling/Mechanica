...
#figure(
  image("files/einsteintriangle-9116603b6a4aebf173f3ca6f7bca8b8d.svg", width: 70%),
  caption: [
Einstein triangle.
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/chx6_gamma_v-7edc72d463dbe9315e72233b96838bed.svg", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/CherenkovRadiation-a24111aac592515ed63592bc40983bf4.jpg", width: 43.75%),
  caption: [
