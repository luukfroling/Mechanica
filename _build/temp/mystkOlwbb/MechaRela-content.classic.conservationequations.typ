...
Updated: 05 feb 2026
In the previous chapters, we have seen that from Newton's three laws, we can obtain conservation laws. That means, under certain conditions (depending on the law), a specific quantity cannot change. <index-imptizwgjg>
...
#figure(
  image("files/ch7_GTsystem-5a6435dec43b5754614a1286f2eeeaeb.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch7_GalileiTransform-12f35c3b5336142565c767ceaaa19a33.svg", width: 40%),
  caption: [
