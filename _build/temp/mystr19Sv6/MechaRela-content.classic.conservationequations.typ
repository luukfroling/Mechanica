...
Updated: 05 feb 2026
In the previous chapters, we have seen that from Newton's three laws, we can obtain conservation laws. That means, under certain conditions (depending on the law), a specific quantity cannot change. <index-ki86lrspof>
...
#figure(
  image("files/ch7_GTsystem-3f2d2fca05ea9e54637072fa250b00cb.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch7_GalileiTransform-662dbe670f47a1d47e204e7d82c4d978.svg", width: 40%),
  caption: [
