...
#figure(
  image("files/ch2_Example1-174abb3d39c5e6450021017546673a89.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
) <fig:example1>
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-apxxqpsgig", heading: [A pushing contest 🌶])[
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_ex_carts-388221c07890738b7549f2031705776d.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
) <fig:pushing-contest>]
...
From Newton's 2$""^(n d)$ and 3$""^r d$ law we can easily derive the law of conservation of momentum. Assume there are only two point-particle (i.e. particles with no size but with mass), that exert a force on each other. No other forces are present. From N2 we have: <index-suuuwkexmt>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Inclined_plane-13fee2ba4d8f24089bbd3295b338ae0e.svg", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Inclined_plane_s-b012def41b27aa888c9fc7558ec6be64.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_vectors-2e1867f53d51d49a23eb381d97e55ea2.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_figure_ex_toss-3d76dc7abcc534c99df3e68d12d6fc22.svg", width: 30%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_fig_hor_mot-4e711c5273bf79ced24fd010a376934a.svg", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/parmotionv-99a4539683ec677139fffcdb4d04b1ce.svg", width: 70%),
  caption: [
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-gdr6mhntws", heading: [Horizontal throw 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/Parabolic-1c9af736a1f720e055fff31148ae1334.png", width: 70%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_ex_pj-323cd17ab58c9a62666c2b1c26b4fc89.svg", width: 90%),
  kind: "figure",
  supplement: [Figure],
)
]
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-ezuivo2v6l", heading: [A rocket in space 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/bookwall-98a50dc7c7388e87f85b8e639048bf99.png", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/FBD_ex_book-3bcc304890f5402f4c363e74f8013a8a.png", width: 60%),
  kind: "figure",
  supplement: [Figure],
) <fig_fbd_book>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Example2-a4b1083d265c7eaf0b9e747823f38a10.svg", width: 20%),
  caption: [
align: center
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_UsingABalance-476620d8899ca3782796755884815cae.svg", width: 40%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_EotvosExperiment-c87219af110abf5d9a015ccec7f74e88.svg", width: 50%),
  caption: [
