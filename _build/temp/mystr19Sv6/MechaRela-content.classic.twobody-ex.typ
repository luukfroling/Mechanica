...
#figure(
  image("files/FourParticles-4f663c8d17039698f0a8eb4f848eb2a2.png", width: 70%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/Wheel8Masses-704410141d85a1e1e761a572bc76449b.png", width: 70%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/FourParticlesVectors-4761b598992f8efb8fe28059b957bda0.png", width: 90%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/Dustparticles_animat-f6dcd6f90c2994c65cc2052dc60a5b4b.png", width: 90%),
  caption: [
