...
#figure(
  image("files/ch2_Example1-3a919de9b2e5eb35130c5205ad2673f4.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
) <fig:example1>
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-idvjh03jig", heading: [A pushing contest 🌶])[
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_ex_carts-d71b9e1925aa3d0d4619ad4f28b5aaf2.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
) <fig:pushing-contest>]
...
From Newton's 2$""^(n d)$ and 3$""^r d$ law we can easily derive the law of conservation of momentum. Assume there are only two point-particle (i.e. particles with no size but with mass), that exert a force on each other. No other forces are present. From N2 we have: <index-lsqyiq8ugw>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Inclined_plane-e27ace5504071855797caa100e2e84d5.svg", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Inclined_plane_s-3ee736bfbbbe770c25defddb77b203d9.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_vectors-44ee50ecf4ded0a8a1a9482d859e9a09.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_figure_ex_toss-27b68e55ac8020e48f4249df4359793e.svg", width: 30%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_fig_hor_mot-dc036df0ff804a0b0930d64195ad0dea.svg", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/parmotionv-d360ee27cd425da9040a984efa82ce3c.svg", width: 70%),
  caption: [
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-aunep2ghjn", heading: [Horizontal throw 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/Parabolic-8468095844a4c5b8a2d1c25f15df936b.png", width: 70%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_ex_pj-13a4f9997b34591b0554d39e23f29438.svg", width: 90%),
  kind: "figure",
  supplement: [Figure],
)
]
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-syea1ai0gz", heading: [A rocket in space 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/bookwall-99d41b7c6a013d5138d474615e21dd94.png", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/FBD_ex_book-e849df8d90526927ade283f7e824b26e.png", width: 60%),
  kind: "figure",
  supplement: [Figure],
) <fig_fbd_book>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Example2-296036999895080e1db40ad874ba4039.svg", width: 20%),
  caption: [
align: center
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_UsingABalance-9079aab44c95fcaf27ced6ceeb0b3504.svg", width: 40%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_EotvosExperiment-1c4e3909a09a08ab2fbda7db3162458e.svg", width: 50%),
  caption: [
