...
#figure(
  image("files/einsteintriangle-b580d852bb03bc0a1028c614da3295b5.svg", width: 70%),
  caption: [
Einstein triangle.
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/chx6_gamma_v-3cdc2e983583b366d7016b04294fd709.svg", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/CherenkovRadiation-b53d86b768159e24dc8a5bb5f2828f2f.jpg", width: 43.75%),
  caption: [
