...
#figure(
  image("files/WorkedEx2.1-ccfb202f92b7355576009e3780706a73.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_figure_ex_hill_s-d46b0a1a64a246de3363451cafc1665b.svg", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Exercise2.1-cd9ab74c8c6c5c080507341997423a25.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_FlyingBall-ba300212f4604ae6741449b9f96d640d.svg", width: 30%),
  kind: "figure",
  supplement: [Figure],
)
]
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Exercise2.4-70717afb5009edb4554339da280ac0ba.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Ex2.5-35c63df275f9ec7005c69a23696961d4.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
) <fig:ex2.5>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Ex2.6-e3d1070f2a65271deda9c6497596ef8a.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
) <fig:ex2.6>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Ex2.7-0edfa7c350e5a9d34e4d01a5f1f00c60.svg", width: 70%),
  kind: "figure",
  supplement: [Figure],
) <fig:ex2.7>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_MaxArea-da13feffc612ad0ae530f39f90c33c25.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
) <fig:maxarea>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_FisMinar-de8731aa301bad056ea78034f78ee12a.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
) <fig:fisminar>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/DroppingAStone-3bde9e584de2b4bd8e5bab19aa75d74c.png", width: 70%),
  caption: [
...
Write a computer program (e.g. in python) that calculates the motion of your object. See #link("/NumericalFallingPart-d688b3acf0858c4bea28128bee19d93c.pdf")[Solution with Python] how you could do that.]
#proof(kind: "exercise", supplement: "Exercise", labelName: "2.17", heading: [Forces on your bike 🌶])[
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_BicycleRide-4c0d9107ea870a8fd539ff30a5640e1d.svg", width: 40%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_bike-b3f725d9f73232fe7ca72749e217dddb.svg", width: 70%),
  kind: "figure",
  supplement: [Figure],
)]
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_SteppingOfABoat-554b68dda3128630b37558ecda829f2d.svg", width: 70%),
  kind: "figure",
  supplement: [Figure],
) <fig:steppingofaboat>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/StampNewton-14d7c1363ede84a123d0630ec939039c.jpg", width: 40%),
  caption: [
align: center
