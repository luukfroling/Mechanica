...
#figure(
  image("files/ch2_Example1-3e675498830fe1846f2d098dde55cb7c.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
) <fig:example1>
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-sm6hjqkpen", heading: [A pushing contest 🌶])[
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_ex_carts-08691f9c84b146b490e058343884b521.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
) <fig:pushing-contest>]
...
From Newton's 2$""^(n d)$ and 3$""^r d$ law we can easily derive the law of conservation of momentum. Assume there are only two point-particle (i.e. particles with no size but with mass), that exert a force on each other. No other forces are present. From N2 we have: <index-aivtfdmx0f>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Inclined_plane-49aa1d953e56facf9b91899ec15b059f.svg", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Inclined_plane_s-6e2e4e4fc1fbde58756b456c42ebdca3.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_vectors-534bd93956005b327535a8265859909d.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_figure_ex_toss-7b01198ec472fc644352e11474deaf07.svg", width: 30%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_fig_hor_mot-d6b1bf83139673ee69ef4f64af5a1714.svg", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/parmotionv-4a012767333f842b03406a2f2f5c3b0f.svg", width: 70%),
  caption: [
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-nzx01vwnca", heading: [Horizontal throw 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/Parabolic-cbad2fcf78c37677e93ace9139807cae.png", width: 70%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_ex_pj-1fd93896c83e36f53f50f24c00ab0a13.svg", width: 90%),
  kind: "figure",
  supplement: [Figure],
)
]
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-tku7pqgl4w", heading: [A rocket in space 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/bookwall-6a96b740407ceed3232b638f495730a4.png", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/FBD_ex_book-26c137aacb78481c767eb6ada3cf390d.png", width: 60%),
  kind: "figure",
  supplement: [Figure],
) <fig_fbd_book>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Example2-a31902d8debb8beef8d0badc425b09ca.svg", width: 20%),
  caption: [
align: center
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_UsingABalance-5269b8c66867024038d78c138c6488d4.svg", width: 40%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_EotvosExperiment-e01cc99b9586386e1dc9039d20323dab.svg", width: 50%),
  caption: [
