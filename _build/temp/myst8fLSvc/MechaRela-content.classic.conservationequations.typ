...
Updated: 05 feb 2026
In the previous chapters, we have seen that from Newton's three laws, we can obtain conservation laws. That means, under certain conditions (depending on the law), a specific quantity cannot change. <index-erpvqbmeli>
...
#figure(
  image("files/ch7_GTsystem-638219e829b28106fcba8e5cc91fc8ff.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch7_GalileiTransform-5016b094a5fedc006bfcc5910737e95b.svg", width: 40%),
  caption: [
