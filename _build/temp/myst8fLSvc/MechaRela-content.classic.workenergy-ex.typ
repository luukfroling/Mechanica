...
#figure(
  image("files/WorkedEx2.1-be22ff9e58eceb823e32affd9231e5bb.svg", width: 60%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/WorkedEx3.2-0804affe49b9800a1c37cb0a27468f28.svg", width: 60%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch3_ex_force_field-0327846c9e4df01fbc8542f99df43e1a.svg", width: 50%),
  caption: [
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-cjwn3ysujn", heading: [🌶])[
...
Click for the solution #link("/ExerciseFrictionNotC-d5d37babda385b1464a7f065131a0bbc.pdf")[Friction Not Conservative].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<52>)[Exercise~4]])[
Click for the solution #link("/ExerciseConservative-d404b090241ee8fb63f2c582ec01e063.pdf")[Conservative Force].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<53>)[Exercise~5]])[
Click for the solution #link("/ExerciseConservative-f9c5b469bd48fe3214c8a64016d508e9.pdf")[Non-Conservative Force].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<54>)[Exercise~6]])[
Click for the solution #link("/PotentialEnergyxy-d86fa25b826b8fb28d7e129aace9372f.pdf")[Potential energy \& Force].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<55>)[Exercise~7]])[
Click for the solution #link("/ForceField-434305a7f9fab25fabf834620c57da26.pdf")[Force Field].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<56>)[Exercise~8]])[
Click for the solution #link("/ForceSin-942e950523f40083b72f114afba457f9.pdf")[Sinusoidal Force Field].]
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch4_ballspring-de11e66261e9f503f5cfd1de77f054bf.svg", width: 35%),
  kind: "figure",
  supplement: [Figure],
)
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-k7r1oseegy", heading: [Pushing a box uphill #footnote[Exercise from Idema, T. (2023). Introduction to particle and continuum mechanics. #cite(<2023>, form: "prose")] 🌶])[
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-c1jgwhcaq8", heading: [Work done dragging a board #footnote[Exercise from Idema, T. (2023). Introduction to particle and continuum mechanics. #cite(<2023>, form: "prose")] 🌶 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch4_draggingboard-ad125083268399e165ff3376c69db281.svg", width: 90%),
  kind: "figure",
  supplement: [Figure],
)
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-pidtpo0afm", heading: [Work by a lineair force 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/WorkExample4_3-15539625be592f9be9a2ecf141e23541.png", width: 70%),
  kind: "figure",
  supplement: [Figure],
)]
