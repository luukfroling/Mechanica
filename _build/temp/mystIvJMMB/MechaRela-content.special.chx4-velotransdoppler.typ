...
#figure(
  image("files/chx4_addvel-d83802a35ea0ca6baacbf2499258be10.svg", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/Doppler_animation-fc174a80c0f047cfdc95f8eb6674b22f.png", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/chx4_doppler2-56e42b7d9455ab8aaa8d04344b76a30c.svg", width: 60%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/chx4_doppler3-cb04b12299cd821010625bde2f400a3c.svg", width: 60%),
  caption: [
.
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/DopplerVelo-145c05c6d9239015bf5f13e1dc063b6b.png", width: 50%),
  caption: [
.
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/1280px-WMAP_2012-a05faccb09090fa89a5289ccab12cf75.png", width: 68.75%),
  caption: [
