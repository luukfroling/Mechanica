...
#figure(
  image("files/ch2_Example1-f3259827fd4a141ca8cdffb7e3dc4b5a.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
) <fig:example1>
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-fpeudrqyo5", heading: [A pushing contest 🌶])[
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_ex_carts-98ab8a1d075f76f3723fd034545c2b49.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
) <fig:pushing-contest>]
...
From Newton's 2$""^(n d)$ and 3$""^r d$ law we can easily derive the law of conservation of momentum. Assume there are only two point-particle (i.e. particles with no size but with mass), that exert a force on each other. No other forces are present. From N2 we have: <index-dqdzxwosnh>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Inclined_plane-acbcdb3c3f12f7175a05fcf16bc8923c.svg", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Inclined_plane_s-372c8397f1c0b968560a4d92363e88d2.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_vectors-76300608128aeb6a6d0625d3cde2929f.svg", width: 40%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_figure_ex_toss-947b13a5dcf153480c3dcd6a6f31f3e1.svg", width: 30%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_fig_hor_mot-6f920be91af6a92549d657dc83288a1c.svg", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/parmotionv-4898dfac1c5ef685e6835f0366a6058f.svg", width: 70%),
  caption: [
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-voa023alcf", heading: [Horizontal throw 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/Parabolic-0b2009121ba777fe0bdccffcccd9c76c.png", width: 70%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_ex_pj-b94332f833a7f1ac49380086ae382d2e.svg", width: 90%),
  kind: "figure",
  supplement: [Figure],
)
]
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-olnirrcak6", heading: [A rocket in space 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/bookwall-1a0b87b567e95e7b6168e3e9ea233ae3.png", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/FBD_ex_book-903a58c3ad39301fd0dbd8be15c8ab18.png", width: 60%),
  kind: "figure",
  supplement: [Figure],
) <fig_fbd_book>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Example2-ae17121cd07036d4869685f77b0ac870.svg", width: 20%),
  caption: [
align: center
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_UsingABalance-66d27fed40583e46762080282db9c3ea.svg", width: 40%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_EotvosExperiment-2b3d29a49b125ca6e013cf0c0a38cecf.svg", width: 50%),
  caption: [
