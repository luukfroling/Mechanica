...
#subpar.grid(figure(
image("files/VortexKnots-b7bf64f101d656cd32a8f7c0ff7b428e.png", width: 50%)
, caption: []), <fig:vortexknots.png>,
figure(
image("files/LordKelvin-a59e1243fee7492bbe884a6ec78bc793.jpg", width: 30%)
...
#show figure: set block(breakable: false)
#subpar.grid(figure(
image("files/PlumPuddingModel-1b637306efdca18a27f266e8cab3ab63.png", width: 50%)
, caption: []), <fig:plumpuddingmodel.png>,
figure(
image("files/JJThomson-9e9dc96d62bf817d33211e9c4b5707a4.jpg", width: 30%)
...
#figure(
  image("files/Mariecurie-02b85bd01c4802d2b0e9849cc2ac41e3.jpg", width: 30%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/RutherfordExperiment-a2ab4282c44725299fa364e5f1c3f98f.png", width: 40%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ErnestRutherford-705c30449e8d095e72817f7d4509dc69.jpg", width: 30%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/RutherfordDeltaP-33f7f951daa66b9cf855a16f3a395a05.png", width: 31.25%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/RutherfordAtom-5bad24732516c23f17b75ea6e8c9c43d.png", width: 25%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/AirPictureOfCERN-712178e96cfbd6ca1dbf965918502508.jpg", width: 43.75%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ScatteringPrinciple-fd9d439c1efc0ba3f7aa04f7e5c94211.png", width: 43.75%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/Scattering2D3D-6629a0eadb6502269d3b6494ef823dac.png", width: 56.25%),
  caption: [
...
#show figure: set block(breakable: false)
#subpar.grid(figure(
image("files/DanielBernoulli-0ada5807629e2d77f40d9a27be66050e.png", width: 40%)
, caption: []), <fig:danielbernoulli.png>,
figure(
image("files/JamesClerkMaxwell-ee48ea44a12d91e5397fb1e72f7191a8.png", width: 40%)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/MichelsonMorleyExp-7d01e70118ad95f2f1934e202e251835.png", width: 35%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/MM-setup-c91a717de65ca3967cf33bd1f48653ec.png", width: 35%),
  kind: "figure",
  supplement: [Figure],
) <fig:mm-setup.png>
