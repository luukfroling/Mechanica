...
#figure(
  image("files/einsteintriangle-6cb18d58482a907e9ff2cde476dda3d9.svg", width: 70%),
  caption: [
Einstein triangle.
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/chx6_gamma_v-8c77a96d3cd313a819fd63fe89c56df3.svg", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/CherenkovRadiation-e9367f5ce53b1a686977af50abf6fc6b.jpg", width: 43.75%),
  caption: [
