...
#figure(
  image("files/ch4_Work-dbe028871210d6cd46197e1462f31a0e.svg", width: 60%),
  caption: [
Path of a particle.
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/force_field-5f7e73d75d340b7e296c01ae13b36678.png", width: 50%),
  kind: "figure",
  supplement: [Figure],
)]
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-bypskcvswm", heading: [Potential \& kinetic energy])[
Proof that the velocity of an object released from a height $H$ will reach the velocity $v = sqrt(2 g H)$.]
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-xgn2l7haoh")[
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-gomuei7hhg")[
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-txb7ju73rf")[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch4_Path12-8c532b57a7ca9d3268fb1cf197c5dd8a.svg", width: 50%),
  caption: [
Two different paths.
],
  kind: "figure",
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/GeorgeStokes-e3566abc79fc115efe7ee1c27bae5035.jpg", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/StokesTheoremExample-06fd289889f9992d7b53da5f373fcc20.png", width: 70%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch4_PotentialStableU-35b6e7c64f06ebeb4effe840e1aa60f6.svg", width: 70%),
  caption: [
