...
#figure(
  image("files/AlbertEinstein-cc3386f771b52dbac599be83e81750de.png", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/chx3_SSprime-a9df841d4421e73ee11844ac2fd02064.svg", width: 43.75%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/chx3_EartMoonSpaceSh-dfdf6c0e70bc08817f3fa1d489bc7a11.svg", width: 70%),
  kind: "figure",
  supplement: [Figure],
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/SSearth2_animation-a934164b4c24127f02095eaa6fc861e8.jpg", width: 100%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/chx3_timedilation1-cb5dee5d0c86ea9c00ce92e14baa3b84.svg", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/chx3_timedilation2-41329213fa54010a6ad8937f666d884e.svg", width: 40%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/chx3_barnladder-b8858124baec89f60a17a3719bd49fc4.svg", width: 80%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/chx3_BL_tot-8230257c3ece4b3eec09571819a85719.svg", width: 100%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/chx3_Bell_paradox-f7253db57e27fc7343cbfe193e30e342.svg", width: 50%),
  caption: [
