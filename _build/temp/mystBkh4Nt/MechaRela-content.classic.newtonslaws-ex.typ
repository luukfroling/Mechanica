...
#figure(
  image("files/WorkedEx2.1-385e3a867377bf9fbf214d760fbd5d54.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_figure_ex_hill_s-f3d21228379dc2977d7e469321482092.svg", width: 50%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Exercise2.1-5955dc7ff0f823f7b789ef0b88a06507.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_FlyingBall-bf7a543a867769a8e965dd5c5071a067.svg", width: 30%),
  kind: "figure",
  supplement: [Figure],
)
]
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Exercise2.4-e2eccaa69e402cd74428faee63707ad2.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Ex2.5-fd6471dd9718966711b18607282b6dcf.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
) <fig:ex2.5>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Ex2.6-b32b7dc97e2062ad86b17c0fd296ad84.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
) <fig:ex2.6>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_Ex2.7-1e73d9daab382372f855ff97ad42a61a.svg", width: 70%),
  kind: "figure",
  supplement: [Figure],
) <fig:ex2.7>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_MaxArea-fe98fae26042928325fdc7396476ef08.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
) <fig:maxarea>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_FisMinar-2d5e450ecbb65d66d8635c01e0dc899a.svg", width: 50%),
  kind: "figure",
  supplement: [Figure],
) <fig:fisminar>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/DroppingAStone-24f1fbc81e04eb940a9eebea61858933.png", width: 70%),
  caption: [
...
Write a computer program (e.g. in python) that calculates the motion of your object. See #link("/NumericalFallingPart-424caf58131ccffbce5989a985513bb7.pdf")[Solution with Python] how you could do that.]
#proof(kind: "exercise", supplement: "Exercise", labelName: "2.17", heading: [Forces on your bike 🌶])[
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_BicycleRide-85228d14479306faae4b42c9e289e69e.svg", width: 40%),
  caption: [
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_bike-084830a1c3607e4c7be3c2f04670bd3d.svg", width: 70%),
  kind: "figure",
  supplement: [Figure],
)]
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch2_SteppingOfABoat-c87dd41c806a7752117aef64a9c0e6fd.svg", width: 70%),
  kind: "figure",
  supplement: [Figure],
) <fig:steppingofaboat>
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/StampNewton-04a085c14783a478039175b5ef1f5da1.jpg", width: 40%),
  caption: [
align: center
