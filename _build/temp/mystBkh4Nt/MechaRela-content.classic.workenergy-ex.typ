...
#figure(
  image("files/WorkedEx2.1-385e3a867377bf9fbf214d760fbd5d54.svg", width: 60%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/WorkedEx3.2-a609655bb460a3702d4c8af51ff97606.svg", width: 60%),
  kind: "figure",
  supplement: [Figure],
)
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch3_ex_force_field-36805eae546379c4b0ac4d4c0ac83c80.svg", width: 50%),
  caption: [
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-lfzdglcrt9", heading: [🌶])[
...
Click for the solution #link("/ExerciseFrictionNotC-25703c486f5146aa740f58922a506adf.pdf")[Friction Not Conservative].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<52>)[Exercise~4]])[
Click for the solution #link("/ExerciseConservative-1d0e760725de0993a9ded7e5ddef4712.pdf")[Conservative Force].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<53>)[Exercise~5]])[
Click for the solution #link("/ExerciseConservative-2a31115a9dfb6b91acdecedf403ef74d.pdf")[Non-Conservative Force].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<54>)[Exercise~6]])[
Click for the solution #link("/PotentialEnergyxy-d0d72abe6e6a6a4f0026787f5932dc15.pdf")[Potential energy \& Force].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<55>)[Exercise~7]])[
Click for the solution #link("/ForceField-6fd1905da2319d07e20c1ea0545c7653.pdf")[Force Field].]
#proof(kind: "solution", supplement: "Solution", labelName: none, heading: [Solution to #link(<56>)[Exercise~8]])[
Click for the solution #link("/ForceSin-d9d437e94a204aea5958df0a9b132f4d.pdf")[Sinusoidal Force Field].]
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch4_ballspring-d1b16871e6e21aa335d5cdc53b5770ac.svg", width: 35%),
  kind: "figure",
  supplement: [Figure],
)
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-clmsc5pooc", heading: [Pushing a box uphill #footnote[Exercise from Idema, T. (2023). Introduction to particle and continuum mechanics. #cite(<2023>, form: "prose")] 🌶])[
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-foaqhu3w9r", heading: [Work done dragging a board #footnote[Exercise from Idema, T. (2023). Introduction to particle and continuum mechanics. #cite(<2023>, form: "prose")] 🌶 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/ch4_draggingboard-8324ad89e9eecd0a0260f144921554ba.svg", width: 90%),
  kind: "figure",
  supplement: [Figure],
)
...
#proof(kind: "exercise", supplement: "Exercise", labelName: "exercise-fvtcb3tysr", heading: [Work by a lineair force 🌶])[
...
#show figure: set block(breakable: breakableDefault)
#figure(
  image("files/WorkExample4_3-0c5e48e18d8d8ec8988e8cef228ce62d.png", width: 70%),
  kind: "figure",
  supplement: [Figure],
)]
